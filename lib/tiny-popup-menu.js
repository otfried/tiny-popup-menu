 ...
 * Built: Thu Oct 17 2024 12:25:49 GMT+0200 (Central European Summer Time)
*/
...
function createElement(tagName, attrs = {}, ...children) {
    ...
    const elem = tagName === null ? new DocumentFragment() : document.createElement(tagName);
...
class TinyPopupMenu extends TinyEmitter {
    ...
    updatePosition(silent = true) {
        ...
        if (location != null) {
            ...
            const calculateLeft = togglerPosition.left + offsetLeft + compensateMenuWidthToCenter;
            let adjustX = 0;
    ...
    _parseOptions(options) {
        ...
        if (mergedOptions.margin === undefined) {
            mergedOptions.margin = ("arrow" in mergedOptions
                ? mergedOptions.arrow
                : true)
                ? 10
                : 2;
